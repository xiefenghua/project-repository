package com.security.im.es.utils;
...
import com.security.im.es.pojo.PropertiesMapping;
import com.security.im.es.pojo.RelationModel;
    ...
    private String getJsonMapping(List<PropertiesMapping> propertiesMappingList) {
        ...
        if (propertiesMappingList != null && !propertiesMappingList.isEmpty()) {
            propertiesMappingList.forEach(propertiesMapping ->
                    // 关系映射优先于字段映射
                    fieldsJson.putOpt(propertiesMapping.getFieldName(), propertiesMapping.getRelationshipMapping() != null ?
                            propertiesMapping.getRelationshipMapping() : propertiesMapping.getFieldMapping()));
        }
        JSONObject propertiesJson = new JSONObject();
        propertiesJson.putOpt(PROPERTIES_KEY, fieldsJson);
        try {
